...
**Número de óbitos residentes por Doenças do Aparelho Circtulatório, segundo faixa etária e Grupo da CID-10, Santo André, 2008-2017**

```{r fig_obitos_idade_tipo_cardiovasculares, fig.height=10, fig.width=15}
